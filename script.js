...
const I18N = {
  pl: {
    ...
    steeringGuideText: "Dla wybranego modelu i konceptu zestawiono pięć generacji z tego samego opisu wejściowego. Wartość α = 0 oznacza generację bazową, natomiast wartości ujemne i dodatnie odpowiadają przeciwnym orientacjom kierunku sterującego. Pierwszy wynik jest wybranym przykładem; pozostałe dziewięć znajduje się poniżej.",
    patchingGuideTitle: "Interpretacja podmiany aktywacji",
    patchingGuideText: "Dla każdej pary opisów wejściowych przedstawiono przebieg bazowy, przebieg źródłowy oraz przebieg po podmianie aktywacji. Interwencja ma przenieść informację o instrumencie z opisu źródłowego do generacji warunkowanej opisem bazowym. Miejsce interwencji wybiera się z listy warstw; domyślnie wyświetlany jest najlepiej oceniony wariant dla danego modelu.",
